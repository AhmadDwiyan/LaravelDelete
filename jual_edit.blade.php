      ...
      <div class="content">
        ...
        <form action="{{ route('jual.update', $datas->id) }}" method="post">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="nohp" name="nohp" value="{{$datas->jumlah}}">
          </div>
          <div class="form-group">
          <label for="alamat">Harga</label>
          <input type="text" class="form-control" id="alamat" name="alamat" value="{{ $datas->total_harga}}">
          </div>
          <div class="form-group">
